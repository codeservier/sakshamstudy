...
function PopularProducts() {
	return (
		<div className="w-full max-w-sm bg-white p-4 rounded-sm border border-gray-200">
			...
			<div className="mt-4 flex flex-col gap-3">
				{popularProducts.map((product) => (
					<Link
						...
						className="flex items-start gap-3 hover:no-underline hover:bg-gray-100 p-2 rounded-md transition-colors"
					>
						...
						<div className="flex-1">
							<p className="text-sm text-gray-800 truncate">{product.product_name}</p>
							<span
